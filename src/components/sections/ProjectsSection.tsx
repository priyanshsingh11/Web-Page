...
const projects = [
  ...
  {
    id: 'agentic-ai-chatbot-repo',
    title: 'Agentic AI Chatbot',
    subtitle: 'Advanced Conversational AI',
    description: 'An intelligent chatbot capable of performing complex tasks through agentic workflows, utilizing advanced NLP techniques for context awareness and reasoning.',
    impact: 'Enhanced user interaction • Multi-turn dialogue',
    tags: ['LangChain', "LangGraph", 'NLP', 'Python', 'LLMs'],
    color: '#00D9FF',
    github: 'https://github.com/priyanshsingh11/agentic-ai-chatbot',
    demo: '#',
  },
