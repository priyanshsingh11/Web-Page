...
const SkillsSection = () => {
  return (
    <section id="skills" className="py-20 px-4 md:px-16 bg-transparent">
      <div className="relative z-10 max-w-7xl mx-auto border-[2px] border-[#853A17] bg-black/85 backdrop-blur-md text-white shadow-[12px_12px_0_0_#000]">
        ...
        <div className="mt-4 border-t-[2px] border-[#853A17] bg-[#853A17]/5 py-4 overflow-hidden">
          <div className="flex animate-marquee whitespace-nowrap">
            {[1, 2, 3, 4].map((i) => (
              <span key={i} className="font-pixel text-sm tracking-[0.2em] text-[#853A17] mx-10 flex items-center gap-4">
